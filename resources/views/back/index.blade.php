                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <table class="table table-responsive-sm text-center">
                            ...
                            <tbody>
                            <tr>
                                <td><img class="media-object round-media height-50" src="/back/app-assets/img/elements/01.png" alt="Generic placeholder image" /></td>
                            ...
                            <tr>
                                <td><img class="media-object round-media height-50" src="/back/app-assets/img/elements/07.png" alt="Generic placeholder image" /></td>
                                <td>Headphones</td>
                                <td>2</td>
                                <td>
                            ...
                            <tr>
                                <td><img class="media-object round-media height-50" src="/back/app-assets/img/elements/11.png" alt="Generic placeholder image" /></td>
                                <td>Camera</td>
                                <td>1</td>
                                <td>
                            ...
                            <tr>
                                <td><img class="media-object round-media height-50" src="/back/app-assets/img/elements/14.png" alt="Generic placeholder image" /></td>
                                <td>Beer</td>
                                <td>2</td>
                                <td>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="media mb-1">
                                <a>
                                    <img alt="96x96" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle" src="/back/app-assets/img/portrait/small/avatar-s-12.png">
                                </a>
                            ...
                            <div class="media mb-1">
                                <a>
                                    <img alt="96x96" class="media-object d-flex mr-3 bg-danger height-50 rounded-circle" src="/back/app-assets/img/portrait/small/avatar-s-11.png">
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media mb-1">
                                <a>
                                    <img alt="96x96" class="media-object d-flex mr-3 bg-success height-50 rounded-circle" src="/back/app-assets/img/portrait/small/avatar-s-3.png">
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media mb-1">
                                <a>
                                    <img alt="96x96" class="media-object d-flex mr-3 bg-warning height-50 rounded-circle" src="/back/app-assets/img/portrait/small/avatar-s-6.png">
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media mb-1">
                                <a>
                                    <img alt="96x96" class="media-object d-flex mr-3 bg-info height-50 rounded-circle" src="/back/app-assets/img/portrait/small/avatar-s-18.png">
                                </a>
                                <div class="media-body">
...
@section("js")
    ...
    <script src="/back/app-assets/vendors/js/chartist.min.js" type="text/javascript"></script>
    <script src="/back/app-assets/js/dashboard1.js" type="text/javascript"></script>
@endsection
